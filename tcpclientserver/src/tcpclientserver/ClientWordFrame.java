 ...
 * It display the word retrieve from the server.
 * 
...
public class ClientWordFrame extends JFrame {
	...
	private JPanel getServerDatePanel(Font font) {
		...
		// Create component to display word length retrieve from the server
		JPanel panel = new JPanel();
		JLabel lblDate = new JLabel ("Word length counted (from Server): ");
